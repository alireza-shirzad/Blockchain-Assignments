...
if __name__ == '__main__':
    ...
    utxo_index = 20 # index of the output you are spending, indices start at 0
    ######################################################################

    txout_scriptPubKey = MULTI_P2PKH_scriptPubKey(Ata_public_key,Faraz_public_key, ShareHolder1_public_key,ShareHolder2_public_key,ShareHolder3_public_key)
